...
--
-- Host: localhost
-- Generation Time: Aug 24, 2019 at 12:42 AM
...
('iphone', 'phones', NULL, NULL, '', '1000.00', '0.00', '1.000', '1.000', 2, 'iphone1.jpg', 0, 0, 0, 0, 0, 0, '', '', '', '', '', '', '', '', '', ''),
...
--
ALTER TABLE `ospos_comp_holding_stocks`
  MODIFY `hold_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `ospos_inventory`
  MODIFY `trans_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;
