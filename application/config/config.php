...
| 
*/ 
$config['application_version'] = '0.0.2';
...
|
*/
$config['encryption_key'] = getenv('ENCRYPTION_KEY') ? getenv('ENCRYPTION_KEY') : '0a9f4007b7c8465d3e9d8d40fa0524158f621a6fff4a6304de0f394134a07257';
...
$config['csrf_exclude_uris'] = array('api/EmployeeApi/login/', 'api/ItemsApi/get_location_items', 'api/ItemsApi/get_all_location_items', 'api/ItemsApi/get_item_detail', );
